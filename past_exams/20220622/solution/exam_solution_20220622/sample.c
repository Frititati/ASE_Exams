...
unsigned int media_pressioni_con_filtro(unsigned int VETT[], 
...
int main (void) {
  ...
  BUTTON_init();												/* BUTTON Initialization              */
	...
	init_timer(1,0x3D090/2 );/*4Hz*/
	init_timer(0,0x53EC60 ); /*5.5 seconds*/
	
	/*we are using the same timer library developed for the other exam */
